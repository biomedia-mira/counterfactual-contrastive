...
This repository contains the code for the paper "Counterfactual contrastive learning: robust representations via causal image synthesis" [pre-print](https://arxiv.org/abs/2403.09605).
